...
<html class="no-js" lang="en">
    <head>
        <title>Online Event Ticket Booking System | Home Page </title>
                    ...
                    <div id="htmlcaption1" class="nivo-html-caption slider-caption-1" >
                        <div class="container">
                            ...
                            <div class="cap-dec wow fadeInDown" data-wow-duration=".9s" data-wow-delay="0.2s" style="margin-top:-100px">
                                        <h1 align="center">Online Event Ticket Booking System</h1>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="cal-to-wrap">
                                <h1 class="section-title">Enter Your Email Address For Events & News Subscribers</h1>
