...
<html lang="en">
<head>
    <title>Online Event Ticket Booking System | Admin login </title>
...
<h3>Online Event Ticket Booking System | Admin login</h3>
</div>
...
<!--Captcha -->
<div class="form-group">
<input type="text"   name="verficationcode" maxlength="5" autocomplete="off" required  style="width: 200px;"  placeholder="Enter Code" autofocus />&nbsp;
<!--Cpatcha Image -->
<img src="captcha.php">
</div>
