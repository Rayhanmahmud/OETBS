...
//$query->bindParam(':bkashh',$bkashh,PDO::PARAM_STR);
//$query->bindParam(':TrxIDD',$TrxIDD,PDO::PARAM_STR);
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p>bKash Payment(Personal Number- 01626351906)</p>
        <p><input type="text" placeholder="bKash Transaction ID" class="info" name="noofmembers" required="true"></p>
